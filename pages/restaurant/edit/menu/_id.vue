<template>
  <section class="page">
    ...
    <Drawer title="Profile Info" placement="left" :closable="false" v-model="drawer">
      <div class="profile">
        ...
        <Menu active-name="1-2" class="menu-side" :open-names="['1']">
          ...
          <Submenu name="1">
            <template slot="title">
              <Icon type="ios-filing"/>Menu list
            </template>
            <MenuItem name="1-1" @click.native="addmenuPopup()">
              <Icon type="md-add"/>Add New menu
            </MenuItem>
            <MenuItem name="1-2">
              <Icon type="md-create"/>Update Menu
            </MenuItem>
          </Submenu>
        </Menu>
      </div>
    ...
    <!-- Menu -->
    <Modal v-model="addMenu" title="Add New Menu" @on-ok="newMenu()" @on-cancel="cancel()">
    ...
    <!--Menu Group -->
    <Modal v-model="addMenugrp" title="Add New Menu" @on-ok="addMenuGroup()" @on-cancel="cancel()">
      <Form label-position="top">
        <FormItem label="Menu Name">
